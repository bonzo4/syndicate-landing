export default function Terms(){
  ...
  return (
    <div className="wrapper pt-32 text-white">
      <header
        className='text-center m-3 text-3xl'
      >
        Terms and Conditions
      </header>

      <article className='text-left mx-10 my-5'>
        <p>
          Syndicate is a distributed application that runs on the Solana
          ...
          The visual asset(s) and artwork of each individual Syndicate NFT is
          hereafter known as the "Art". Syndicate LLC (“Syndicate”, “we”,
          ...
          the “App”. Using the App, users can view their Syndicate NFT, and use the
          Smart Contracts to acquire Syndicate NFT on the Solana network. The App,
          ...
          “Terms”). The purchase of a Syndicate NFT does NOT CONSTITUTE AN
          INVESTMENT.
          <br />
          <br />
          ...
          SMART CONTRACTS, AND THE SITE, UNLESS Syndicate HAS AGREED TO
          DIFFERENT WRITTEN AGREEMENT WITH YOU TO THE CONTRARY, SIGNED BY BOTH
          PARTIES. Syndicate IS ONLY WILLING TO MAKE THE APP, THE SMART
